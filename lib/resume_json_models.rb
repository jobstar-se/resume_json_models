...
Dir[File.join(File.dirname(__FILE__), 'resume_json_models', '*.rb')].each do |model|
  require model
end

autoload :PublishDateValidator, "resume_json_models/validators/publish_date_validator"
